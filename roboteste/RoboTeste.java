...
/**
 * Coisa - a class by (Quarteto Fantastico)
 */
import robocode.*;
...
public class RoboTeste extends AdvancedRobot {
    ...
    public void onScannedRobot(ScannedRobotEvent e) {
        System.out.println("Minha velocidade: " + getVelocity());
        System.out.println("Direção do meu adversário: " + getDirection(e));
